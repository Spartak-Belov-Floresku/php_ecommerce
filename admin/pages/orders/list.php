...
if(!empty($srch)){
	...
	$empty = 'There are no results matching your searching critera.';
}else{
...
<table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
	...
	<tr>
		...
		<td><?php echo Helper::encodeHtml(1, $order->date); ?></td>
		<td class="ta_r">&dollar;<?php echo number_format($order->total, 2); ?></td>
		<td class="ta_r">
		...
		<td class="ta_r"><?php echo $order->payment_status != null? $order->payment_status: "Peding"; ?></td>
		<td class="ta_r">
		...
		<td class="ta_r">
		<a href="?page=orders&amp;action=edit&amp;id=<?php echo $order->id; ?>">View</a>
		</td>
	</tr>
