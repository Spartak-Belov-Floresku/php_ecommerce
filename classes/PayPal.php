...
class PayPal{
		...
		// urls
		private $_url_production = 'https://www.paypal.com/cgi-bin/websrc';
		private $_url_sandbox = 'https://www.sandbox.paypal.com/cgi-bin/websrc';
		...
		// your paypal id
		private $_business = 'seller_bzz@mail.com';
		...
		private function validateIpn(){
			...
			//mail("spartakkuzminus@gmail.com","PayPal 0", $hostname);
		...
		private function sendCurl(){
				...
				//mail("spartakkuzminus@gmail.com","PayPal 1",$response);
				...
				//mail("spartakkuzminus@gmail.com","PayPal 2", $this->_ipn_result);
				curl_close($ch);
